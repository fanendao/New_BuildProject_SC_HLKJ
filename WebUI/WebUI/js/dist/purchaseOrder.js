...
THISPAGE = {
    ...
    initDom: function (a) {
        ...
        150501 == a.transType ? this.classes.setValue(0) : this.classes.setValue(1),
        ...
        requiredMoney && ($("#accountWrap").show(), this.accountCombo = Business.accountCombo($("#account"), {
            width: 112,
            height: 300,
            emptyOptions: !0,
            addOptions: {
        ...
        if (this.btn_add = c, this.btn_edit = d, this.btn_audit = f, this.btn_view = e, this.btn_reaudit = g, this.btn_turn = i, this.btn_close = j, this.btn_open = k, a.id > 0) {
            if (this.$_number.text(a.billNo), this.$_date.val(a.date), this.$_deliveryDate.val(a.deliveryDate), this.$_totalArrears.val(a.totalArrears), this.$_accountInfo.data("accountInfo", a.accounts), -1 === a.accId && (this.$_accountInfo.show(), b.$_payment.attr("disabled", "disabled").addClass("ui-input-dis")), $("#grid").jqGrid("footerData", "set", {
                ...
                var m = d + f;
                a.isDelete ? m = e + k : m += billRequiredCheck ? a.checked ? j : "" : j,
                this.$_toolBottom.html('<span id="groupBtn">' + m + "</span>" + l)
            } else if (a.checked) {
                $("#mark").addClass("has-audit");
                var m = i + e + g;
                a.isDelete ? m = e + k : m += j,
                this.$_toolBottom.html('<span id="groupBtn">' + m + "</span>" + l)
            } else {
                var m = e;
                m += a.isDelete ? k : billRequiredCheck ? a.checked ? j : "" : j,
                this.$_toolBottom.html('<span id="groupBtn">' + m + "</span>" + l)
            }
        ...
        } else billRequiredCheck ? this.$_toolBottom.html('<span id="groupBtn">' + c + f + "</span>") : this.$_toolBottom.html('<span id="groupBtn">' + c + "</span>"),
    ...
    loadGrid: function (a) {
        ...
        var u = "grid";
        q.mod_PageConfig.gridReg(u, t),
        t = q.mod_PageConfig.conf.grids[u].colModel,
        $("#grid").jqGrid({
            data: a.entries,
            datatype: "clientSide",
            autowidth: !0,
    ...
    reloadData: function (a) {
        function b() {
            ...
            150501 === a.transType ? c.classes.setValue(0) : c.classes.setValue(1),
        ...
        b(),
        "edit" === a.status ? this.editable || (c.enableEdit(), $("#groupBtn").html(c.btn_edit + c.btn_audit), $("#mark").removeClass("has-audit")) : this.editable && (c.disableEdit(), $("#groupBtn").html(c.btn_turn + c.btn_view + c.btn_reaudit), $("#mark").addClass("has-audit"))
    },
    initCombo: function () {
        var a = this;
    ...
    addEvent: function () {
        ...
        this.$_deliveryDate.bind("keydown",
        function (a) {
        ...
        function (b) {
            ...
            function (b) {
                if (200 === b.status) {
                    ...
                    a.$_createTime.html((new Date).format("yyyy-MM-dd hh:mm:ss")).parent().show(),
                    originalData.id = b.data.id;
                    var c = a.btn_edit;
                    c += billRequiredCheck ? a.btn_audit : a.btn_audit + a.btn_close,
    ...
    _getEntriesData: function () {
        for (var a = [], b = $("#grid").jqGrid("getDataIDs"), c = 0, d = b.length; d > c; c++) {
            ...
            if ("" !== g.goods) {
                ...
                $("#grid").jqGrid("editCellByColName", f, "locationName"),
                !1;
                ...
                taxRequiredCheck && (e.taxRate = g.taxRate, e.tax = g.tax, e.taxAmount = g.taxAmount),
                a.push(e)
            }
        }
        return a
    ...
    getPostData: function () {
        ...
        if ("" === c.val()) return b.$_customer.removeData("contactInfo"),
        parent.Public.tips({
            type: 2,
            content: "请选择供应商！"
        }),
        b.customerCombo.active = !0,
        b.customerCombo.doQuery(),
        b.customerCombo.input.focus(),
        !1;
        ...
        if (e.length > 0) {
            ...
            return taxRequiredCheck && (g.totalTax = $("#grid").jqGrid("footerData", "get").tax.replace(/,/g, ""), g.totalTaxAmount = $("#grid").jqGrid("footerData", "get").taxAmount.replace(/,/g, "")),
            g
        }
