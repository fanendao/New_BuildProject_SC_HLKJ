...
var dataReflush, list = {
    ...
    systemParameter: {
        name: "网店参数",
        href: WDURL + "/online-store/system-parameter.jsp?language=zh-CHS&site=SITE_MAIN&siId=" + SYSTEM.DBID + "&scheme=" + SCHEME + "&logonName=" + SYSTEM.userName,
        dataRight: "",
        target: "vip-onlineStoreSetting"
    },
    orderHandle1: {
...
menu = {
    ...
    _menuControl: function () {
        ...
        b = SYSTEM.isAdmin,
        c = SYSTEM.siVersion;
        switch (this._hide(["authority", "reInitial", "backup", "onlineStoreMap", "onlineStoreList", "onlineStoreRelation", "logisticsList", "printSettings", "systemParameter", "orderHandle1", "orderHandle2", "orderHandle3", "refundList", "orderList", "onlineSalesList", "goodsComboList", "JDStorageList", "JDStorageGoodsList", "JDStoragePurchaseOrderList", "JDStorageSaleOrderList", "JDStorageInvManage", "assistingProp", "serNumStatus", "serNumTracer", "batchList", "batchTracer"]), a) {
            case 1:
                this._hide(["purchaseOrder", "purchaseOrderList", "purchaseView", "salesOrder", "salesOrderList", "verification", "verificationList", "shippingAddress", "puOrderTracking", "salesOrderTracking", "assemble", "disassemble", "serNumStatus", "serNumTracer", "batchList", "batchTracer"]);
                break;
            case 2:
        }
        switch (c) {
...
$(window).load(function (a) {
    ...
    function (a) {
        ...
        var d = [{
            ...
            focus: !0,
            callback: function () {
                1 === SYSTEM.siVersion ? Public.tips({
                    type: 2,
                    content: "试用版不能续费！"
