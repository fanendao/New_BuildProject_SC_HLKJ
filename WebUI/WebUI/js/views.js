BizQQWPA.define("wpa.APIs.addCustom", "globalSettings,lang.each,lang.typeEnhance,lang.extend,util.getJSONP,util.domain,wpa.wpaMgr",
function (require) {
...
function (require) {
    ...
    var global = window;
    var WPA_TYPE_TA_INVITE_ONLY = "0",
    WPA_TYPE_NORMAL = "1",
    WPA_TYPE_LINK = "2",
    WPA_TYPE_CUSTOM = "3",
    SESSION_VERSION_TA = "4",
    WPA_STYLE_TYPE_INVITE = "20",
    APPOINTED_TYPE_AUTO = "0",
    APPOINTED_TYPE_KFEXT = "1",
    APPOINTED_TYPE_GROUP = "2",
    WPA_FLOAT_TYPE_FIXED = "0",
    WPA_FLOAT_TYPE_SCROLL = "1",
    WPA_FLOAT_POSITION_X_LEFT = "0",
    WPA_FLOAT_POSITION_X_CENTER = "1",
    WPA_FLOAT_POSITION_X_RIGHT = "2",
    WPA_FLOAT_POSITION_Y_TOP = "0",
    WPA_FLOAT_POSITION_Y_CENTER = "1",
    WPA_FLOAT_POSITION_Y_BOTTOM = "2",
    IS_INVITE_WPA_FALSE = "0",
    IS_INVITE_WPA_TRUE = "1",
    CHAT_TYPE_AIO = 1,
    CHAT_TYPE_ANONYMOUS = 2;
    var SPEED_REPORT_DISPLAY = .1,
    ...
    var WPA = function (params) {
        ...
        switch (this.wty) {
            ...
            case WPA_TYPE_CUSTOM:
                this.custom()
        } !this.kfuin && kfuinCache.get(nameAccount,
        function (data) {
            data && (self.kfuin = data)
        }); !this.sid && sidCache.get(nameAccount,
        function (data) {
            data && (self.sid = data)
        });
        report("http://prom.b.qq.com/se/r.gif?na=" + nameAccount + "&ref=" + encodeURIComponent(document.referrer))
    };
    WPA.prototype = {
        render: function () {
            var params = this.params;
            var width, height, type = parseInt(params["type"]),
            typeStr,
            isFloat = false;
            switch (type) {
                case 1:
        ...
        createWPA: function () {
            ...
            var loaded = function () {
                ...
                iDoc.open();
                iDoc.write(['<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">', '<html xmlns="http://www.w3.org/1999/xhtml">', "<head>", '<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />', browser.msie && iframe.src !== "about:blank" ? "<script>document.domain='" + document.domain + "';</script>" : "", "</head>", "<body>", view.templ, "</body>", "</html>"].join(""));
                iDoc.close();
        ...
        initFloatWPA: function () {
            ...
            width = this.width,
            height = this.height;
            node.style.cssText = ["display:none;", "position:absolute;", type === 20 ? "z-index:2147483647!important;" : "z-index:2147483646!important;"].join(" ");
        ...
        launchChat: function (callback) {
            ...
            reportWpa("http://report.b.qq.com/crmReport/clicklog", {
        ...
        launchAIOChat: function () {
            ...
            return function (callback) {
                ...
                getJSONP("http://wpd.b.qq.com/cgi/get_sign.php", opts,
                function (rs) {
...
BizQQWPA.define("wpa.wpaMgr", "globalSettings,lang.each,util.proxy,util.cookie,util.titleFlash,util.report,util.serialize,util.domain,wpa.WPA",
function (require) {
    var globalSettings = require("globalSettings"),
    each = require("each"),
    proxy = require("proxy"),
    ...
    var displayReport = function (params) {
        var url = "http://prom.b.qq.com/wpadisplay/r.gif?",
...
BizQQWPA.define("util.Bits", "util.proxy,util.pad",
function (require) {
...
BizQQWPA.define("util.getJSONP", "util.getScript,util.serialize",
function (require) {
...
BizQQWPA.define("util.events",
function () {
    var events = {};
    events.addEvent = window.addEventListener ?
    ...
    events.removeEvent = window.removeEventListener ?
    function (node, type, event) {
...
BizQQWPA.define("util.onLoad", "util.events",
function (require) {
...
BizQQWPA.define("util.Panel", "lang.browser,util.Style,util.className,util.events,util.offset,util.css,util.proxy",
function (require) {
...
BizQQWPA.define("util.onIframeLoaded",
function () {
...
BizQQWPA.define("wpa.getQQVersion", "globalSettings,lang.browser,util.events",
function (require) {
    var globalSettings = require("globalSettings"),
    browser = require("browser"),
    events = require("events");
    ...
    return function (callback) {
        ...
        if (browser.mozilla || browser.webkit) {
            ...
            iframe.style.display = "none";
            events.addEvent(window, "message",
            function (event) {
...
BizQQWPA.define("wpa.ViewHelper", "util.getJSONP,util.report,util.proxy,util.onLoad,util.className,util.events,util.Style,util.titleFlash",
function (require) {
    ...
    ViewHelper.prototype = {
        ...
        setTimingRpt: function (f1, f2, f3_ie, f3_c) {
            var _t, _p = window.performance || window.webkitPerformance || window.msPerformance,
            _ta = ["navigationStart", "unloadEventStart", "unloadEventEnd", "redirectStart", "redirectEnd", "fetchStart", "domainLookupStart", "domainLookupEnd", "connectStart", "connectEnd", "requestStart", "responseStart", "responseEnd", "domLoading", "domInteractive", "domContentLoadedEventStart", "domContentLoadedEventEnd", "domComplete", "loadEventStart", "loadEventEnd"],
            _da = [],
            _t0,
            _tmp,
            f3 = f3_ie;
        ...
        getOnlineStatus: function () {
            ...
            var url = "http://crm2.qq.com/cgi/portalcgi/get_kf_status.php",
            opts = {
                kfuin: params.kfuin,
                aty: params.aty,
                al: appointList
...
function () {
    return {
        ...
        i01: {
            templ: ['<div class="main bg">', '<a id="launchBtn" class="launchBtn btn" href="javascript:;"></a>', '<a id="laterBtn" class="laterBtn btn" href="javascript:;"></a>', '<a id="closeBtn" class="closeBtn btn" href="javascript:;"></a>', '<p id="title" class="title">在线咨询</p>', '<div class="content">', '<p id="msg" class="msg"></p>', "</div>", "</div>"].join(""),
            ...
            init: function (context, helper) {
                ...
                var chat = function () {
                    ...
                    helper.report("http://visitor.crm2.qq.com/cgi/visitorcgi/ajax/accept_invite.php?nameAccount=" + this.params.nameAccount + "&uid=" + this.params.uid)
                },
                close = function () {
                    this.remove();
                    helper.titleFlash.off();
                    helper.report("http://visitor.crm2.qq.com/cgi/visitorcgi/ajax/reject_invite.php?nameAccount=" + this.params.nameAccount + "&uid=" + this.params.uid)
                };
